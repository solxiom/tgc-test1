...
import com.solxiom.social.account.JdbcAccountRepository;
 ...
 */
@Configuration
@ComponentScan(basePackages = "com.solxiom.social", excludeFilters = { @Filter(Configuration.class) })
@PropertySource("classpath:com/solxiom/social/config/application.properties")
