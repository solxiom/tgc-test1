...
<div class="container">
	...
	<div id="productForm" class="span-12 last">
		<form:form modelAttribute="productModel" action="product"
			method="POST">
			<table id="productTable">
				...
				<tr>
					<td><form:label for="description" path="description"
							cssErrorClass="error">Description</form:label></td>
					<td><form:input path="description" /></td>
					<td><form:errors path="description" /></td>
				</tr>
				<tr>
					<td><form:label for="company" path="company"
							cssErrorClass="error">Company</form:label></td>
